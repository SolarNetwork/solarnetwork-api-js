...
/**
 * A mixin class that adds support for SolarNode properties to a <code>UrlHelper</code>.
 * 
...
const NodeUrlHelperMixin = (superclass) => class extends superclass {
     ...
     * 
     * This gets the first available node ID from the <code>nodeIds</code> property.
     * 
     * @returns {number} the default node ID, or <code>null</code>
     */
    get nodeId() {
     ...
     * Set the node ID.
     * 
     * This will set the <code>nodeIds</code> property to a new array of just the given value.
     * 
     ...
     * 
     * This gets the first available source ID from the <code>sourceIds</code> property.
     * 
     * @returns {string} the default source ID, or <code>null</code>
     */
    get sourceId() {
     ...
     * Set the source ID.
     * 
     * This will set the <code>sourceIds</code> property to a new array of just the given value.
     * 
